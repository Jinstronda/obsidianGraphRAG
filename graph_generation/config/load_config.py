...
from graph_generation.config.create_graph_generation_config import create_graph_generation_config
...
def load_config(
    ...
    return create_graph_generation_config(config_data, root_dir=str(root))
