...
from graph_generation.config.embeddings import default_embeddings
from graph_generation.config.enums import (
    AsyncType,
    AuthType,
    CacheType,
    ChunkStrategyType,
...
@dataclass
class graph_generationConfigDefaults:
    """Default values for graph_generation."""
...
graph_generation_config_defaults = graph_generationConfigDefaults()
