...
from graph_generation.config.models.extract_graph_nlp_config import TextAnalyzerConfig
from graph_generation.index.operations.build_noun_graph.np_extractors.base import (
    BaseNounPhraseExtractor,
)
from graph_generation.index.operations.build_noun_graph.np_extractors.cfg_extractor import (
    CFGNounPhraseExtractor,
)
from graph_generation.index.operations.build_noun_graph.np_extractors.regex_extractor import (
    RegexENNounPhraseExtractor,
)
from graph_generation.index.operations.build_noun_graph.np_extractors.stop_words import (
    EN_STOP_WORDS,
)
from graph_generation.index.operations.build_noun_graph.np_extractors.syntactic_parsing_extractor import (
