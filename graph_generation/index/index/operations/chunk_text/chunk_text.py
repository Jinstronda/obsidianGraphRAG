...
from graph_generation.config.models.chunking_config import ChunkingConfig, ChunkStrategyType
from graph_generation.index.operations.chunk_text.typing import (
    ChunkInput,
    ChunkStrategy,
)
from graph_generation.logger.progress import ProgressTicker, progress_ticker
...
def load_strategy(strategy: ChunkStrategyType) -> ChunkStrategy:
    ...
    match strategy:
        case ChunkStrategyType.tokens:
            from graph_generation.index.operations.chunk_text.strategies import run_tokens

            return run_tokens
        case ChunkStrategyType.sentence:
            # NLTK
            from graph_generation.index.operations.chunk_text.bootstrap import bootstrap
            from graph_generation.index.operations.chunk_text.strategies import run_sentences
