...
from graph_generation.config.embeddings import create_collection_name
from graph_generation.index.operations.embed_text.strategies.typing import TextEmbeddingStrategy
from graph_generation.vector_stores.base import BaseVectorStore, VectorStoreDocument
from graph_generation.vector_stores.factory import VectorStoreFactory
...
def load_strategy(strategy: TextEmbedStrategyType) -> TextEmbeddingStrategy:
    ...
    match strategy:
        case TextEmbedStrategyType.openai:
            from graph_generation.index.operations.embed_text.strategies.openai import (
                run as run_openai,
            )

            return run_openai
        case TextEmbedStrategyType.mock:
            from graph_generation.index.operations.embed_text.strategies.mock import (
                run as run_mock,
            )
