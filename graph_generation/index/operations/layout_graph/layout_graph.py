...
from graph_generation.index.operations.embed_graph.typing import NodeEmbeddings
from graph_generation.index.operations.layout_graph.typing import GraphLayout
...
def _run_layout(
    ...
    if enabled:
        from graph_generation.index.operations.layout_graph.umap import (
            run as run_umap,
        )
    ...
    from graph_generation.index.operations.layout_graph.zero import (
        run as run_zero,
    )
