...
from graph_generation.index.operations.layout_graph.typing import (
    GraphLayout,
    NodePosition,
)
...
def compute_umap_positions(
    ...
    # NOTE: This import is done here to reduce the initial import time of the graph_generation package
    import umap
