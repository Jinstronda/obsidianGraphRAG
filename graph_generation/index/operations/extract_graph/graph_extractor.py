...
from graph_generation.index.utils.string import clean_str
from graph_generation.language_model.protocol.base import ChatModel
from graph_generation.prompts.index.extract_graph import (
    CONTINUE_PROMPT,
...
class GraphExtractor:
    ...
    def __init__(
        ...
        self._max_gleanings = (
            ...
            else graph_generation_config_defaults.extract_graph.max_gleanings
        )
