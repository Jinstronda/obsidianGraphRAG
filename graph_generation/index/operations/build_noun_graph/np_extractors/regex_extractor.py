...
from graph_generation.index.operations.build_noun_graph.np_extractors.resource_loader import (
...
class RegexENNounPhraseExtractor(BaseNounPhraseExtractor):
    ...
    def __init__(
        ...
        NOTE: This is the extractor used in the first bencharmking of Lazygraph_generation but it only works for English.
