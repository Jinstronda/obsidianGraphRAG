...
"""Persona generating module for fine-tuning graph_generation prompts."""

from graph_generation.language_model.protocol.base import ChatModel
from graph_generation.prompt_tune.defaults import DEFAULT_TASK
from graph_generation.prompt_tune.prompt.persona import GENERATE_PERSONA_PROMPT


async def generate_persona(
    model: ChatModel, domain: str, task: str = DEFAULT_TASK
) -> str:
    """Generate an LLM persona to use for graph_generation prompts.
