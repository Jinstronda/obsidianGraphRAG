...
"""Language detection for graph_generation prompts."""

from graph_generation.language_model.protocol.base import ChatModel
from graph_generation.prompt_tune.prompt.language import DETECT_LANGUAGE_PROMPT


async def detect_language(model: ChatModel, docs: str | list[str]) -> str:
    """Detect input language to use for graph_generation prompts.
